...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* <div className="fixed top-0 left-0 right-0 bottom-0 bg-white bg-opacity-50 z-[1000] h-auto flex justify-center overflow-hidden pointer-events-none ">
        <div className="bg-default flex w-fullx h-fullx rounded-lg shadow-lg p-4 m-3">
          fdfd
        </div>
      </div> */}
    </>
